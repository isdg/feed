...
url: https://www.stephendiehl.com/posts/monads/
published: "2013-07-07T01:00:00Z"
feed: diehl
guid: https://www.stephendiehl.com/posts/monads/
---
...
The identity functor $1\_\\mathcal{C}$ for a category $\\mathcal{C}$ is a functor mapping all objects to
...
![](https://www.stephendiehl.com/images/naturality.svg)

The natural transformation itself is shown diagrammatically between two functors as:

![](https://www.stephendiehl.com/images/nat.svg)
...
2. A natural transformation $\\eta : 1\_\\mathcal{C} \\rightarrow T$
...
![](https://www.stephendiehl.com/images/coherence1.svg)

And a triangle equality:

$$

\\mu \\circ T \\eta = \\mu \\circ \\eta T = 1\_C \

$$

![](https://www.stephendiehl.com/images/coherence2.svg)
...
![](https://www.stephendiehl.com/images/string3.svg)

With the coherence conditions given diagrammatically:

![](https://www.stephendiehl.com/images/string1.svg)

![](https://www.stephendiehl.com/images/string2.svg)
...
1. Objects in the Kleisli category are objects from the underlying
   ...
   category.
2. Morphisms are Kleisli arrows of the form : $f : A \\rightarrow

   T B$
3. Identity morphisms in the Kleisli category are precisely $\\eta$

   in the underlying category.
4. Composition of morphisms $f \\circ g$ in terms of the host category is
...
3. $\\mathtt{fmap}$ applies a function over the elements of a
...
1. $\\eta$ returns a pure value to a value within the context of
   ...
   the computation.
2. $\\mu$ turns a sequence of IO operation into a single

   IO operation.
3. $\\mathtt{fmap}$ applies a function over the result
