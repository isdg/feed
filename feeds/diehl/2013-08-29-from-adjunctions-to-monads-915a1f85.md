...
url: https://www.stephendiehl.com/posts/adjunctions/
published: "2013-08-29T01:00:00Z"
feed: diehl
guid: https://www.stephendiehl.com/posts/adjunctions/
---
...
![](https://www.stephendiehl.com/images/string4.png)
...
![](https://www.stephendiehl.com/images/string10.png)
...
![](https://www.stephendiehl.com/images/string6.png)
...
![](https://www.stephendiehl.com/images/string5.png)

The identity natural transform mapping a functor $F$ to itself is

written $1\_F$ and in Haskell is just ( `id`). The composition of

natural transformations follows the associativity laws, shown

below:

![](https://www.stephendiehl.com/images/string13.png)
...
A diagram example for a natural transformation $\\eta : 1\_\\mathcal{C}

\\rightarrow {FG}$ between the identity functor and the

composition functor of $FG$ would be drawn as:

![](https://www.stephendiehl.com/images/string7.png)
...
\\eta : 1\_\\mathcal{D} \\rightarrow FG

$$

![](https://www.stephendiehl.com/images/string8.png)

Such that the following *triangle identities* hold:

$$

(\\epsilon F) \\circ (F \\eta) = 1\_F \

(G \\epsilon) \\circ (\\eta G) = 1\_G

$$

These are drawn below:

![](https://www.stephendiehl.com/images/string9.png)
...
\\mu \\circ T \\eta = \\mu \\circ \\eta T = 1\_T \

$$

![](https://www.stephendiehl.com/images/string3.png)
...
![](https://www.stephendiehl.com/images/string1.png)

![](https://www.stephendiehl.com/images/string2.png)

In Haskell we can [normally construct](http://www.stephendiehl.com/posts/monads.html) the
...
![](https://www.stephendiehl.com/images/string11.png)
