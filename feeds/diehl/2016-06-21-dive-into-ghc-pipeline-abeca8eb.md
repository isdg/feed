...
url: https://www.stephendiehl.com/posts/ghc_01/
published: "2016-06-21T01:00:00Z"
feed: diehl
guid: https://www.stephendiehl.com/posts/ghc_01/
---
...
2. [OPLSS: Adventures in Types](https://www.youtube.com/watch?v=6COvD8oynmI)
3. [2006 GHC Hackathon Videos](https://ghc.haskell.org/trac/ghc/wiki/AboutVideos)
4. [David Terei's Notes](https://davidterei.com/talks/2016-03-cs240h/ghc-compiler.html)
5. [Takenobu Tani's GHC Illustrated](https://takenobu-hs.github.io/downloads/haskell_ghc_illustrated.pdf)
6. [Edward Yang's Blog](http://blog.ezyang.com/2011/04/tracing-the-compilation-of-hello-factorial/)
...
encompasses the [GHC API](https://downloads.haskell.org/~ghc/7.10.3/docs/html/libraries/ghc-7.10.3/index.html).
...
The six core passes make up the [compilation pipeline](http://www.aosabook.org/images/ghc/hscpipe2.png):
...
This however can be extended via the “GHC\_PACKAGE\_PATH” environment variable
...
platform-agnostic [readline](https://cnswww.cns.cwru.edu/php/chet/readline/rltop.html) abstraction) then read up on that first.
...
So that's our custom Mini GHCi. In practice [real GHCi](https://github.com/ghc/ghc/tree/master/libraries/ghci) does things a
