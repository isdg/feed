...
feed: jyn
guid: https://jyn.dev/reverse-engineering-x86-assembly/
---

# Reverse Engineering x86 assembly

## Intro [Anchor link for: intro](https://jyn.dev/reverse-engineering-x86-assembly/\#intro)
...
## GDB Basics [Anchor link for: gdb-basics](https://jyn.dev/reverse-engineering-x86-assembly/\#gdb-basics)
...
This post is continued in [Buffer Overflows and Stacks and Assembly, Oh My](https://jyn.dev/buffer-overflows-and-stacks-and-assembly-oh-my/).
