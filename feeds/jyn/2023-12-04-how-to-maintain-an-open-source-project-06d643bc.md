...
feed: jyn
guid: https://jyn.dev/how-to-maintain-an-open-source-project/
---
...
## Balancing priorities [Anchor link for: balancing-priorities](https://jyn.dev/how-to-maintain-an-open-source-project/\#balancing-priorities)
...
- Automate everything you find boring. CI, releases, updating dependencies, formatting, documentation are all good candidates here. Remember that it’s better to e.g. have a release that’s missing pre-compiled binaries than no release at all. There are many tools that can do this for you; a few examples in the rust ecosystem are Github Actions, [cargo-dist](https://opensource.axo.dev/cargo-dist/), dependabot, rustfmt, and rustdoc.
...
## Culture [Anchor link for: culture](https://jyn.dev/how-to-maintain-an-open-source-project/\#culture)
...
## Recruiting maintainers [Anchor link for: recruiting-maintainers](https://jyn.dev/how-to-maintain-an-open-source-project/\#recruiting-maintainers)
...
I have a lot more to say on this, but most of it has already been said by my friend Alice Cecile in [this wonderful talk](https://www.youtube.com/watch?v=xM7bI2OPPLQ). Go watch it. Seriously, go watch it, it's only 20 minutes and none of them are wasted.
