...
## wonder [Anchor link for: wonder](https://jyn.dev/wonder/\#wonder)

### things i have seen [Anchor link for: things-i-have-seen](https://jyn.dev/wonder/\#things-i-have-seen)

![lightning striking. the timing is perfect such that half the night sky is illuminated by the bolt and half is not.](https://jyn.dev/assets/lightning.jpg)
...
![a small square black block, with the engraved text: in the land of gods and monsters, i was an angel living in the garden of evil](https://jyn.dev/assets/angel%20in%20the%20garden.jpg)
...
![a blurry, distorted picture of a city. in the foreground is an apartment building. in the background is a set of sky scrapers. the sky above is dark, but no stars are visible.](https://jyn.dev/assets/austin%20from%20office.jpg)
...
![a picture of a city, taken from a tall rooftop. there is a glass building to the right and ornate architectures to the left. the street is filled with lights. far above, the clouds are dark grey against a bright setting sun.](https://jyn.dev/assets/mlk%20library.jpg)

i took this photo from the roof of MLK library in DC. i felt like the city was alive around me. i still do.

![a picture taken from an airplane windows. in the top left is the sun, blurred into an incomprehensible shape by the window pane. to the right is empty space. below are layered clouds, that look almost like ocean waves.](https://jyn.dev/assets/30000%20feet.jpg)

this is the closest i will come to visiting space.

### things i have heard [Anchor link for: things-i-have-heard](https://jyn.dev/wonder/\#things-i-have-heard)
...
### things i have read [Anchor link for: things-i-have-read](https://jyn.dev/wonder/\#things-i-have-read)
...
### things i have created [Anchor link for: things-i-have-created](https://jyn.dev/wonder/\#things-i-have-created)
...
## joy [Anchor link for: joy](https://jyn.dev/wonder/\#joy)

### things i have seen [Anchor link for: things-i-have-seen-1](https://jyn.dev/wonder/\#things-i-have-seen-1)

![a github comment by @Nilstrieb: hello can anyone review my code please :ferrisClueless: please i have been waiting for weeks now all you do is meow please just one approval please](https://jyn.dev/assets/nils%20meow.jpg)

i burst into laughter every time i see this.

FUCK YOU CHICAGO AND NORTHWESTERN RAILROAD COMPANY

### things i have created [Anchor link for: things-i-have-created-1](https://jyn.dev/wonder/\#things-i-have-created-1)
