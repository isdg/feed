...
feed: jyn
guid: https://jyn.dev/the-rust-project-has-a-burnout-problem/
---

# the rust project has a burnout problem

![a melting, smiling, ferris. it's surrounded by the cursive text "burned out rust kid club".](https://jyn.dev/assets/burned%20out%20rust%20club.png)
...
## what does this look like [Anchor link for: what-does-this-look-like](https://jyn.dev/the-rust-project-has-a-burnout-problem/\#what-does-this-look-like)
...
## what can i do about it [Anchor link for: what-can-i-do-about-it](https://jyn.dev/the-rust-project-has-a-burnout-problem/\#what-can-i-do-about-it)
...
## what can team leads do about it [Anchor link for: what-can-team-leads-do-about-it](https://jyn.dev/the-rust-project-has-a-burnout-problem/\#what-can-team-leads-do-about-it)
...
*take these problems seriously*. [prioritize growing the team and creating a healthy environment over solving technical issues](https://jyn.dev/2023/12/04/How-to-maintain-an-open-source-project.html). **the issues will still be there in a few months; your people may not be**.

## what can the rust project do about it [Anchor link for: what-can-the-rust-project-do-about-it](https://jyn.dev/the-rust-project-has-a-burnout-problem/\#what-can-the-rust-project-do-about-it)
...
## be well. be kind to each other. i love you. [Anchor link for: be-well-be-kind-to-each-other-i-love-you](https://jyn.dev/the-rust-project-has-a-burnout-problem/\#be-well-be-kind-to-each-other-i-love-you)

remember:

> EMPATHY WITHOUT BOUNDARIES IS SELF DESTRUCTION [pic.twitter.com/HbBwEj4hc3](https://t.co/HbBwEj4hc3)
>
> — 𖤐ARCH BUDZAR𖤐 (@ArchBudzar) [October 6, 2020](https://twitter.com/ArchBudzar/status/1313572660048269315?ref_src=twsrc%5Etfw)

### acknowledgements [Anchor link for: acknowledgements](https://jyn.dev/the-rust-project-has-a-burnout-problem/\#acknowledgements)
