...
i have a version of [tools i have my eye on](https://jyn.dev/tools/#tools-i-have-my-eye-on) for myself that i keep regularly updated. i will probably not keep this public copy updated, unless i find a tool that's sufficiently good i want to tell people about it.

i'm always on the lookout for more useful tools. if you have a tool you use regularly that's not on this list (and not specific to a single language ecosystem), please [let me know](mailto:blog@jyn.dev). the one exception is containerization software. i am interested in tools to *interact* with containers, but at this time i am not looking for more container hosts (podman, kubernetes, vagrant, lxc, systemd-nspawn, firejail, chroot, etc).

## tools i use [Anchor link for: tools-i-use](https://jyn.dev/tools/\#tools-i-use)

### basics [Anchor link for: basics](https://jyn.dev/tools/\#basics)
...
### shell [Anchor link for: shell](https://jyn.dev/tools/\#shell)
...
### editor [Anchor link for: editor](https://jyn.dev/tools/\#editor)
...
### terminal multiplexing [Anchor link for: terminal-multiplexing](https://jyn.dev/tools/\#terminal-multiplexing)
...
### debugging [Anchor link for: debugging](https://jyn.dev/tools/\#debugging)
...
- [rr](https://rr-project.org/): time travel debugging. this doesn't exist on macOS; if you know a counterpart *please* [let me know](mailto:blog@jyn.dev).

### C/C++ tools [Anchor link for: c-c-tools](https://jyn.dev/tools/\#c-c-tools)
...
### rust tools [Anchor link for: rust-tools](https://jyn.dev/tools/\#rust-tools)
...
### "everything else" [Anchor link for: everything-else](https://jyn.dev/tools/\#everything-else)
...
## tools i have my eye on [Anchor link for: tools-i-have-my-eye-on](https://jyn.dev/tools/\#tools-i-have-my-eye-on)

i either use these occasionally enough i need a reference, or haven't used them yet but want to.

### debugging [Anchor link for: debugging-1](https://jyn.dev/tools/\#debugging-1)
...
### operating systems [Anchor link for: operating-systems](https://jyn.dev/tools/\#operating-systems)
...
### containers [Anchor link for: containers](https://jyn.dev/tools/\#containers)
...
### development [Anchor link for: development](https://jyn.dev/tools/\#development)
...
### editing and diffing [Anchor link for: editing-and-diffing](https://jyn.dev/tools/\#editing-and-diffing)
...
### graphics [Anchor link for: graphics](https://jyn.dev/tools/\#graphics)
...
### benchmarking [Anchor link for: benchmarking](https://jyn.dev/tools/\#benchmarking)
