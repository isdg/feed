...
feed: jyn
guid: https://jyn.dev/operators-not-users-and-programmers/
---
...
## consider how the spreadsheets grow [Anchor link for: consider-how-the-spreadsheets-grow](https://jyn.dev/operators-not-users-and-programmers/\#consider-how-the-spreadsheets-grow)

spreadsheets are hugely successful. Felienne Hermans, who has spent her career studying spreadsheets, [attributes this success](https://www.felienne.com/archives/2453) to " *their immediate feedback system and their continuous deployment model*": the spreadsheet shows you its result as soon as you open it, and it requires no steps to run other than to install Excel and double-click the file.
...
## the “user/programmer” distinction [Anchor link for: the-user-programmer-distinction](https://jyn.dev/operators-not-users-and-programmers/\#the-user-programmer-distinction)
...
## what could a malleable system with [low technical risk](https://nothingisnttrivial.com/technical-functional.html) look like? [Anchor link for: what-could-a-malleable-system-with-low-technical-risk-look-like](https://jyn.dev/operators-not-users-and-programmers/\#what-could-a-malleable-system-with-low-technical-risk-look-like)

let's start by looking at what malleable systems already exist.

### malleable languages [Anchor link for: malleable-languages](https://jyn.dev/operators-not-users-and-programmers/\#malleable-languages)
...
- [my blog](https://jyn.dev/how-i-write-blog-posts/)
...
### malleable version control [Anchor link for: malleable-version-control](https://jyn.dev/operators-not-users-and-programmers/\#malleable-version-control)
...
### malleable deployment [Anchor link for: malleable-deployment](https://jyn.dev/operators-not-users-and-programmers/\#malleable-deployment)
...
### putting it together [Anchor link for: putting-it-together](https://jyn.dev/operators-not-users-and-programmers/\#putting-it-together)
...
- [automatic and continuous durability](https://jyn.dev/complected-and-orthogonal-persistence), like autosave in microsoft office products.
...
## bibliography [Anchor link for: bibliography](https://jyn.dev/operators-not-users-and-programmers/\#bibliography)
...
## P.S: what will people build with this power? [Anchor link for: p-s-what-will-people-build-with-this-power](https://jyn.dev/operators-not-users-and-programmers/\#p-s-what-will-people-build-with-this-power)

i consulted a local friend of mine, a polisci major, and asked him what he would build if he were able to program. he said a penguin that walks across the screen, followed by a puffin friend for him. so, here's to penguins 🐧 ![penguin](https://jyn.dev/900.jpg)![puffin](https://jyn.dev/Puffin_(Fratercula_arctica).jpg)
