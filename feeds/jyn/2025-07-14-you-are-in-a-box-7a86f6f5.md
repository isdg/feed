...
feed: jyn
guid: https://jyn.dev/you-are-in-a-box/
---
...
## switching costs and growth [Anchor link for: switching-costs-and-growth](https://jyn.dev/you-are-in-a-box/\#switching-costs-and-growth)
...
once you start using a tool for one purpose, due to switching costs, you want to keep using that tool. so you start using it for things that wasn’t designed for, and as a result, tools tend to grow and grow and grow until they [stagnate](https://jyn.dev/technical-debt-is-different-from-technical-risk/#what-to-do-about-risk). in a sense, we have replicated the business boom-and-bust cycle in our own tools.

## interoperability [Anchor link for: interoperability](https://jyn.dev/you-are-in-a-box/\#interoperability)
...
### back-compat [Anchor link for: back-compat](https://jyn.dev/you-are-in-a-box/\#back-compat)

tools and languages can decrease switching costs by keeping backwards compatibility with older tools, or at least being close enough that they’re [easy to learn](https://youtu.be/SxdOUGdseq4?si=X9OZ975hwwzZOxpo&t=346) for people coming from those tools. for example, ripgrep has almost exactly the same syntax as GNU grep, and nearly every compiled language since C has kept the curly braces.

### standardization [Anchor link for: standardization](https://jyn.dev/you-are-in-a-box/\#standardization)
...
### FFI [Anchor link for: ffi](https://jyn.dev/you-are-in-a-box/\#ffi)
...
### IPC [Anchor link for: ipc](https://jyn.dev/you-are-in-a-box/\#ipc)

#### Unix shells [Anchor link for: unix-shells](https://jyn.dev/you-are-in-a-box/\#unix-shells)
...
#### structured IPC [Anchor link for: structured-ipc](https://jyn.dev/you-are-in-a-box/\#structured-ipc)
...
#### RPC [Anchor link for: rpc](https://jyn.dev/you-are-in-a-box/\#rpc)
...
## bibliography [Anchor link for: bibliography](https://jyn.dev/you-are-in-a-box/\#bibliography)
...
- [Microsoft, "PowerShell 7.5: about\_Output\_Streams"](https://learn.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_output_streams?view=powershell-7.5)
...
1. blog post forthcoming [↩](https://jyn.dev/you-are-in-a-box/#fr-1-1)
