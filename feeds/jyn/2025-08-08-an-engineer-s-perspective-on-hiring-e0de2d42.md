...
feed: jyn
guid: https://jyn.dev/an-engineers-perspective-on-hiring/
---
...
## hiring sucks [Anchor link for: hiring-sucks](https://jyn.dev/an-engineers-perspective-on-hiring/\#hiring-sucks)
...
this post explores why hiring is hard, how existing approaches fail, and what a better approach could look like. my goal, of course, is to get my friends hired. [reach out to me](mailto:blog@jyn.dev) if you like the ideas here.

## what makes a good interview [Anchor link for: what-makes-a-good-interview](https://jyn.dev/an-engineers-perspective-on-hiring/\#what-makes-a-good-interview)
...
### live coding, often called "leetcode interviews" [Anchor link for: live-coding-often-called-leetcode-interviews](https://jyn.dev/an-engineers-perspective-on-hiring/\#live-coding-often-called-leetcode-interviews)
...
### take-home interviews [Anchor link for: take-home-interviews](https://jyn.dev/an-engineers-perspective-on-hiring/\#take-home-interviews)
...
### extended essays and work samples [Anchor link for: extended-essays-and-work-samples](https://jyn.dev/an-engineers-perspective-on-hiring/\#extended-essays-and-work-samples)
...
### code review [2](https://jyn.dev/an-engineers-perspective-on-hiring/\#fn-2) [Anchor link for: code-review](https://jyn.dev/an-engineers-perspective-on-hiring/\#code-review)
...
## imagining a better interview process [Anchor link for: imagining-a-better-interview-process](https://jyn.dev/an-engineers-perspective-on-hiring/\#imagining-a-better-interview-process)
...
thank you for reading! i hope this inspires you to change your own hiring processes, or at least to write a comment telling me why i'm wrong ^^. you can reach me by [email](mailto:blog@jyn.dev) if you want to comment privately.

---

## P.S. other interview processes [Anchor link for: p-s-other-interview-processes](https://jyn.dev/an-engineers-perspective-on-hiring/\#p-s-other-interview-processes)

### pairing [Anchor link for: pairing](https://jyn.dev/an-engineers-perspective-on-hiring/\#pairing)
...
## P.P.S. measuring interview effectiveness [Anchor link for: p-p-s-measuring-interview-effectiveness](https://jyn.dev/an-engineers-perspective-on-hiring/\#p-p-s-measuring-interview-effectiveness)
...
1. update from after publishing: a friend said they’ve seen people successfully use chatgpt to game design interviews. oof. [↩](https://jyn.dev/an-engineers-perspective-on-hiring/#fr-1-1)

2. this section was added the day after publishing in response to feedback from senior engineers and hiring managers. [↩](https://jyn.dev/an-engineers-perspective-on-hiring/#fr-2-1)
