...
feed: jyn
guid: https://jyn.dev/how-to-communicate-with-intent/
---
...
## adapt to your audience [Anchor link for: adapt-to-your-audience](https://jyn.dev/how-to-communicate-with-intent/\#adapt-to-your-audience)

First, think about your audience. Adapt your message to the person you’re speaking to. Someone learning Rust for the first time does not need an infodump about variance and type coercion, they need an introduction to enums, generics, and pattern matching. Similarly, if a barista asks you what the weird code on your screen is, don’t tell them you’re writing a [meta-Static Site Generator in Clojure](https://codeberg.org/jyn514/flower/), tell them you’re building a tool to help people create websites.
...
## consider your purpose [Anchor link for: consider-your-purpose](https://jyn.dev/how-to-communicate-with-intent/\#consider-your-purpose)
...
### corollary: don't argue for argument's sake [Anchor link for: corollary-don-t-argue-for-argument-s-sake](https://jyn.dev/how-to-communicate-with-intent/\#corollary-don-t-argue-for-argument-s-sake)

Don’t fight losing causes, [unless the cause is really worth it](https://boardgamegeek.com/blog/5988/blogpost/76876/if-youre-going-to-do-something-that-crazy). Someone on hacker news saying "language A Sucks and you Should use language B instead" is not worth arguing with. Someone who says "language A is good in scenario X, but has shortcomings in scenario Y compared to language B" is much more serious and worth listening to. Arguing with someone who refuses to be convinced wastes everyone’s time.

## balance conversational effort [Anchor link for: balance-conversational-effort](https://jyn.dev/how-to-communicate-with-intent/\#balance-conversational-effort)
...
## consider implications [Anchor link for: consider-implications](https://jyn.dev/how-to-communicate-with-intent/\#consider-implications)
...
### not everyone wants to hear an infodump [Anchor link for: not-everyone-wants-to-hear-an-infodump](https://jyn.dev/how-to-communicate-with-intent/\#not-everyone-wants-to-hear-an-infodump)
...
### apologies are not the time to infodump [Anchor link for: apologies-are-not-the-time-to-infodump](https://jyn.dev/how-to-communicate-with-intent/\#apologies-are-not-the-time-to-infodump)
...
### infodumps will not prevent all miscommunication [Anchor link for: infodumps-will-not-prevent-all-miscommunication](https://jyn.dev/how-to-communicate-with-intent/\#infodumps-will-not-prevent-all-miscommunication)
...
## be legible [Anchor link for: be-legible](https://jyn.dev/how-to-communicate-with-intent/\#be-legible)
