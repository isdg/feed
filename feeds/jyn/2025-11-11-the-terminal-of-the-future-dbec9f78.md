...
feed: jyn
guid: https://jyn.dev/the-terminal-of-the-future/
---
...
## a mental model of a terminal [Anchor link for: a-mental-model-of-a-terminal](https://jyn.dev/the-terminal-of-the-future/\#a-mental-model-of-a-terminal)
...
## what does a better terminal look like? [Anchor link for: what-does-a-better-terminal-look-like](https://jyn.dev/the-terminal-of-the-future/\#what-does-a-better-terminal-look-like)
...
### a first try: Jupyter [Anchor link for: a-first-try-jupyter](https://jyn.dev/the-terminal-of-the-future/\#a-first-try-jupyter)
...
### some problems [Anchor link for: some-problems](https://jyn.dev/the-terminal-of-the-future/\#some-problems)
...
## how does that work? [Anchor link for: how-does-that-work](https://jyn.dev/the-terminal-of-the-future/\#how-does-that-work)

### shell integration [Anchor link for: shell-integration](https://jyn.dev/the-terminal-of-the-future/\#shell-integration)
...
### long-lived processes [Anchor link for: long-lived-processes](https://jyn.dev/the-terminal-of-the-future/\#long-lived-processes)
...
#### interacting [Anchor link for: interacting](https://jyn.dev/the-terminal-of-the-future/\#interacting)

To interact with a process, you need bidirectional communication, i.e. you need a "cell output" that is also an input. An example would be any TUI, like `top`, `gdb`, or `vim` [1](https://jyn.dev/the-terminal-of-the-future/#fn-1). Fortunately, Jupyter is really good at this! The whole design is around having [interactive outputs](https://ipywidgets.readthedocs.io/en/latest/) that you can change and update.
...
#### suspending [Anchor link for: suspending](https://jyn.dev/the-terminal-of-the-future/\#suspending)
...
#### disconnecting [Anchor link for: disconnecting](https://jyn.dev/the-terminal-of-the-future/\#disconnecting)
...
### rerun and undo/redo [Anchor link for: rerun-and-undo-redo](https://jyn.dev/the-terminal-of-the-future/\#rerun-and-undo-redo)
...
### derived features [Anchor link for: derived-features](https://jyn.dev/the-terminal-of-the-future/\#derived-features)
...
#### needs a Jupyter notebook frontend [Anchor link for: needs-a-jupyter-notebook-frontend](https://jyn.dev/the-terminal-of-the-future/\#needs-a-jupyter-notebook-frontend)
...
#### needs shell integration [Anchor link for: needs-shell-integration](https://jyn.dev/the-terminal-of-the-future/\#needs-shell-integration)
...
#### needs sandboxed tracing [Anchor link for: needs-sandboxed-tracing](https://jyn.dev/the-terminal-of-the-future/\#needs-sandboxed-tracing)
...
## ok but how do you build this [Anchor link for: ok-but-how-do-you-build-this](https://jyn.dev/the-terminal-of-the-future/\#ok-but-how-do-you-build-this)
...
### stage 1: transactional semantics [Anchor link for: stage-1-transactional-semantics](https://jyn.dev/the-terminal-of-the-future/\#stage-1-transactional-semantics)
...
### stage 3: structured RPC [Anchor link for: stage-3-structured-rpc](https://jyn.dev/the-terminal-of-the-future/\#stage-3-structured-rpc)

This bit depends on the client/server model. Once you have a server interposed between the terminal emulator and the client, you can start doing really funny things like tagging I/O with metadata. This lets all data be timestamped[3](https://jyn.dev/the-terminal-of-the-future/#fn-3) and lets you distinguish input from output. [xterm.js](https://jvns.ca/blog/2022/07/20/pseudoterminals/) works something like this. When combined with shell integration, this even lets you distinguish shell prompts from program output, at the *data* layer.

Now you can start doing really funny things, because you have a *structured log* of your terminal session. You can replay the log as a recording, like [asciinema](https://asciinema.org/) [4](https://jyn.dev/the-terminal-of-the-future/#fn-4); you can transform the shell prompt without rerunning all the commands; you can import it into a Jupyter Notebook or [Atuin Desktop](https://blog.atuin.sh/atuin-desktop-runbooks-that-run/); you can save the commands and rerun them later as a script. Your terminal is data.

### stage 4: jupyter-like frontend [Anchor link for: stage-4-jupyter-like-frontend](https://jyn.dev/the-terminal-of-the-future/\#stage-4-jupyter-like-frontend)
...
## jyn, what the fuck [Anchor link for: jyn-what-the-fuck](https://jyn.dev/the-terminal-of-the-future/\#jyn-what-the-fuck)
...
## bibliography [Anchor link for: bibliography](https://jyn.dev/the-terminal-of-the-future/\#bibliography)
...
1. there are a *lot* of complications here around [alternate mode](https://ratatui.rs/concepts/backends/alternate-screen/), but I'm just going to skip over those for now. A simple way to handle alternate mode (that doesn't get you nice things) is just to embed a raw terminal in the output cell. [↩](https://jyn.dev/the-terminal-of-the-future/#fr-1-1)

2. otherwise you could start replaying output from inside an escape, which is [not good](https://mosh.org/#:~:text=evil%20escape%20sequences). I had a detailed email exchange about this with the alden author which I have not yet had time to write up into a blog post; most of the complication comes when you want to avoid replaying the *entire* history and only want to replay the visible viewport. [↩](https://jyn.dev/the-terminal-of-the-future/#fr-2-1)

3. hey, this seems awfully like [asciinema](https://asciinema.org/)! [↩](https://jyn.dev/the-terminal-of-the-future/#fr-3-1)

4. oh, that's why it seemed like asciinema. [↩](https://jyn.dev/the-terminal-of-the-future/#fr-4-1)
