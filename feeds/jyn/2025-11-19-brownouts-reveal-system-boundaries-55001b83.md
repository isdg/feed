...
feed: jyn
guid: https://jyn.dev/brownouts-reveal-system-boundaries/
---
...
## uptime [Anchor link for: uptime](https://jyn.dev/brownouts-reveal-system-boundaries/\#uptime)
...
## system boundaries [Anchor link for: system-boundaries](https://jyn.dev/brownouts-reveal-system-boundaries/\#system-boundaries)
...
## backup plans [Anchor link for: backup-plans](https://jyn.dev/brownouts-reveal-system-boundaries/\#backup-plans)
...
## testing your backups [Anchor link for: testing-your-backups](https://jyn.dev/brownouts-reveal-system-boundaries/\#testing-your-backups)

One way to avoid uptime reliance is brownouts, where services are down or only partially available for a predetermined amount of time. Google intentionally brownouts their internal infrastructure so that nothing relies on another service being up 100% at the time[1](https://jyn.dev/brownouts-reveal-system-boundaries/#fn-1). This forces errors to be constantly tested, and exposes dependency cycles.
...
## it could happen here [Anchor link for: it-could-happen-here](https://jyn.dev/brownouts-reveal-system-boundaries/\#it-could-happen-here)
...
1. Of course, they don't brown-out their external-facing infra. That would lose them customers. [↩](https://jyn.dev/brownouts-reveal-system-boundaries/#fr-1-1)
