...
feed: lucumr
guid: https://lucumr.pocoo.org/2026/5/24/pi-oss/
---
...
![Weekly external volume and acceptance rate of Pi issues and pull requests](/static/pi-issue-tracker-volume.png)
...
![Pi terminal session showing an agent analysis with a GitHub issue widget displaying the issue title, author, and URL.](/static/pi-issue-session-widget.png)
