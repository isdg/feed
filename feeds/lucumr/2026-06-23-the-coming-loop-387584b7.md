...
feed: lucumr
guid: https://lucumr.pocoo.org/2026/6/23/the-coming-loop/
---
...
new](https://ghuntley.com/ralph/). We have been doing versions of this since early Claude Code days, but that loop is becoming ever more present in agentic engineering and in recent weeks it has started to dominate the Twitter discourse.
...
Furthermore it’s well understood that models tend to observe some local failure and add a local defense. [Karpathy
