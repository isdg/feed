---
title: "Dabbling in the Cryptographic World"
url: https://cm-bell-labs.github.io/who/dmr/crypt.html
published: "2000-01-01T00:00:00Z"
feed: ritchie
guid: https://cm-bell-labs.github.io/who/dmr/crypt.html
---
...
John Markoff and recorded in the book by Markoff and Katie Hafner (Cyberpunk: Outlaws
and Hackers on the Computer Frontier, Simon and Schuster, 1991).
...
like typo and other things, and with Thompson was responsible for the password
encryption scheme that is still used today, together with its predecessors.
(If you can handle Postscript, a 31KB paper describing
the history of this password mechanism is available.)
He was also the author of the series of crypt programs that came
...
to his crypt commands as a sequence of graded exercises, it's evident
...
from the 1930s at least through the 1950s. Kahn's The Codebreakers has a good account
and pictures.
On the web, there is a page describing it
...
One of the crypt commands in early Unix (Sixth Edition, 1974) was based on
...
published in Cryptologia in July, 1978.
...
It used no a priori knowledge except for
...
It was submitted to Cryptologia, and also,
...
release for the Reeds and Weinberger paper about Unix crypt
("File Security and the UNIX System Crypt Command", AT&T BLTJ 63 #8 part 2,
Oct 1984; 110KB Postscript version available).
...
- Bell Labs management strongly supported open publication of research results
...
- NSA cautioned that some in the agency believed that the national
...
from publication in Cryptologia.
...
owes to Yves Gyldén; see Kahn's book for references to
Gyldén's sanguine view of the security of such machines.
