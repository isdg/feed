---
title: "Primeval C: Two Very Early Compilers"
url: https://cm-bell-labs.github.io/who/dmr/primevalC.html
published: "2001-01-01T00:00:00Z"
feed: ritchie
guid: https://cm-bell-labs.github.io/who/dmr/primevalC.html
---
...
information: Warren Toomey, now at Bond University,
has managed to make
...
As described in the C History paper, 1972-73 were
...
(A story about using this hardware is told elsewhere.)
...
their current meaning. Their declaration syntax seems to use () instead
of {}, but . and -> for specifying members of
...
in the C manual a couple of years after
these versions.

Instead, pointer declarations were
written in the style int ip[];.
...
the * notation, even though it doesn't use it.
...
operators as .s (assembler language) files.

Finally, there is the cvopt program, used
...
(See the top of the page for one who succeeded.)
