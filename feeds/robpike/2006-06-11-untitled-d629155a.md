...
I can't find this on the web, so here follows a note I wrote in
1991
...
would be fine: I'd been invited by Butler Lampson to talk about
Plan 9
...
The problem, I said, is that MIT and I are connected by some
history.
...
in academia. Especially at MIT. Especially among the
undergraduates.
...
colloquially called \`\`backing store,'' a technique for
implementing

windows on a bitmap display. This patent is of particular interest

to Stallman because he claims to have used the idea, before the
patent
...
portfolio of computer graphics patents, with #4,555,775 being
central.
...
I was therefore not surprised early Monday afternoon, as we were
eating
...
Jerry Saltzer went to his office to get a copy of the
announcement,
...
You may have heard that AT&T has a patent on a simple technique
called

"backing store" which consists of saving the hidden parts of a
window
...
Rob Pike, who obtained this patent for AT&T, is going to be
visiting

Tech Square on Monday afternoon. If you don't like AT&T's

monopolistic threat, now's the time to express your opinion by
joining
...
Please make a sign, even an el-cheapo sign, to identify yourself
as

part of the protest. Make up a slogan on the subject of Pike,
AT&T,
...
(Pike has spoken publicly in favor of software patents and the
backing

store patent in particular. He is thus not a reluctant participant
in
...
This notice has some characteristic inaccuracies, of which the
worst
...
at a company (to complain about Lotus's \`\`look and feel''
lawsuit),
...
I quickly identified the protesters: they were the ones in the
back
...
\- Excuse me, would you mind moving? I won't be able to see the
screen.
...
story I told, a technical explanation of how distributed
applications

are built in Plan 9 using its namespace operations (patent applied
for).

The protesters were surprised, I think, that my subject was
interesting

to them. At one point they all applauded spontaneously when I
described
...
half the questions (all technical) during and after the talk were
from

the protesters. Stallman said nothing.

Afterwards an LCS member said that, as a result of Stallman's
ploy,
...
I accomplished my purpose of delivering a \`\`seminar on \[my\]
latest
